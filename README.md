...
A game that let the users guess the name of the country based on the given :triangular_flag_on_post: flag. The app lets the user see the location on the globe and by the end of the game, gives out pointers to review.

Consider checking the repo's issues, all of my todos are in there :smile:

![Screenshot](./guessthecountry1.png)
![Screenshot](./guessthecountry2.png)
![Screenshot](./guessthecountry3.png)
