...
import formatNumbersWithCommas from '../helpers/formatNumbers';

class CountryMap extends React.Component {

  render() {
    const { lat, lng, name, capital, region, subregion, population, flag } = this.props;
    const position = [lat, lng]
    const pop = formatNumbersWithCommas(population)

    return (

      <LeafletMap center={position} zoom={7.5}>

        <TileLayer
          attribution='Map data &copy; <a href="https://www.openstreetmap.org/">OpenStreetMap</a> contributors, <a href="https://creativecommons.org/licenses/by-sa/2.0/">CC-BY-SA</a>, Imagery © <a href="https://www.mapbox.com/">Mapbox</a>'
          url='https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token={accessToken}'
          id='mapbox/streets-v11'
          accessToken='pk.eyJ1Ijoicm9va2llbW9ua2V5IiwiYSI6ImNrYmp6OGMxZzB1NzgzMG9kZmxmb3h0dWIifQ.0zEhykA2dZXo1QCMXq-mnw'
        />
        ...
        <Marker position={position}>
          ...
          >
            ...
            <p className="popup-details"><strong>Capital: </strong> {capital} </p>
            <p className="popup-details"><strong>Region: </strong> {region} </p>
            <p className="popup-details"><strong>Subregion: </strong> {subregion} </p>
            <p className="popup-details"><strong>Population: </strong> {pop} </p>
          </Tooltip>
        </Marker>
